...
vim.pack.add({
    ...
    -- renovate: digest=5a2c1dff42ca1055dc8977f1ad3217e42ce72659
    ...
    -- renovate: digest=957fe64ab8244772d7d61f9b402c6ac0fd085928
    { src = "https://github.com/delphinus/md-render.nvim", name = "md-render.nvim", version = "v3.8.2" },
