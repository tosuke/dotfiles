...
vim.pack.add({
    ...
    -- renovate: digest=2ef33149c7caf5a6be0f74f2a6c119f8cfbe37d6
    { src = "https://github.com/delphinus/md-render.nvim", name = "md-render.nvim", version = "v3.5.0" },
    ...
    -- renovate: digest=8b98b4470eb326f1c7b50dae79f8c963568e5720
